...
def tun_parameters(train_x, train_y):  # 通过这个函数，确定树的个数
    xgb1 = XGBClassifier(learning_rate=0.01, n_estimators=200, max_depth=10, min_child_weight=1, gamma=0, subsample=0.8,
                         colsample_bytree=0.8, objective='binary:logistic', scale_pos_weight=1, eval_metric='auc',seed=1440,silent=0)
