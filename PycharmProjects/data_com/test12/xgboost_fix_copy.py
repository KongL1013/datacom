...
get = np._c([total_xg_pred[:,1],y_xg_pred[:,1]])
print(get)
print("len get = ",len(get))
y_xg_pred1 = pd.DataFrame(y_xg_pred[:,1],columns=['pred1'])
y_xg_pred2 = pd.DataFrame(y_xg_pred[:,1],columns=['pred2'])

##end


total_xg_pred_1 = pd.DataFrame(total_xg_pred[:,1],columns=['pred1'])
total_xg_pred_2 = pd.DataFrame(total_xg_pred[:,1],columns=['pred2'])
